            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        <label class="col-sm-3 control-label">{{ $lang->STARTDATE }}</label>
                        <div class="col-sm-9">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label class="col-sm-3 control-label">{{ $lang->DATAFINAL }}</label>
                        <div class="col-sm-9">
                ...
                <div class="col-md-4">
                    <input type="submit" class="btn btn-success" value="{{ $lang->EXPT }}" />
                </div>
            </div>
